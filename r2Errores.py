...
mayor_edad = edades.index(min(edades)) # La función .index() de las listas busca un valor en la lista y devuelve su índice
...
dato_a_buscar = ("Dato a buscar en la lista de aprendices: ")
